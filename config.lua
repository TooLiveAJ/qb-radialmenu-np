...
rootMenuConfig =  {
    ...
    {    
        ...
        enableMenu = function()
            ...
            local isdead = Player.metadata["isdead"]
             ...
             return isPolice and not isdead and not inlaststand and onduty --and onDuty
        end,
    ...
    {    
        ...
        enableMenu = function()
            ...
            local isdead = Player.metadata["isdead"]
             ...
             return isPolice and not isdead and not inlaststand and onduty
        end,
    ...
    icon = "#hospital-amb",
    enableMenu = function()
         return isMedic and not isdead and not inlaststand and onduty
    end,
...
},
{
    ...
    enableMenu = function()
        ...
        local isdead = Player.metadata["isdead"]
         ...
         return isTow and not isdead and not inlaststand
    end,
...
},
{
    ...
    enableMenu = function()
        ...
        local isdead = Player.metadata["isdead"]
         ...
         return isTaxi and not isdead and not inlaststand
    end,
